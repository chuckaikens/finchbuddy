...
export const metadata: Metadata = {
  ...
  description: "FinchBuddy privacy policy — how we collect, use, and protect your data.",
  alternates: { canonical: "https://finchbuddy.com/privacy-policy" },
};
    ...
    <>
      ...
      <main className="pt-[70px] md:pt-[120px] min-h-screen">
        <div className="max-w-screen-2xl mx-auto px-8 md:px-24 mt-16">
          ...
          <div className="prose prose-lg max-w-3xl text-on-surface/90 leading-relaxed font-body [&_h2]:font-headline [&_h2]:text-3xl [&_h2]:font-extrabold [&_h2]:tracking-tight [&_h2]:text-on-surface [&_h2]:mt-12 [&_h2]:mb-6 [&_p]:mb-6">
            <h2>Who we are</h2>
            <p>Our website address is: https://finchbuddy.com.</p>
